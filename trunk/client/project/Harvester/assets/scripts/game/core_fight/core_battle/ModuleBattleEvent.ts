export class ModuleBattleEvent {
    ...
    public static readonly ON_BATTLE_FRIEND_ROUND_START:string = "ON_BATTLE_FRIEND_ROUND_START"; // 战斗友方回合开始阶段
    public static readonly ON_BATTLE_FRIEND_ROUND_START_EXIT:string = "ON_BATTLE_FRIEND_ROUND_START_EXIT"; // 战斗友方回合开始阶段退出
    public static readonly ON_BATTLE_ENEMY_ROUND_START:string = "ON_BATTLE_ENEMY_ROUND_START"; // 战斗敌方回合开始阶段
    public static readonly ON_BATTLE_ENEMY_ROUND_START_EXIT:string = "ON_BATTLE_ENEMY_ROUND_START_EXIT"; // 战斗敌方回合开始阶段退出
