...
export class WindowTravel extends AbstractUIWindow {
    ...
    protected onInit(): void {
        ...
        let view = UICore.createObject("Travel", "WindowTravel").asCom;
        if (view) {
            this._view = view;
        } else {
            console.error("创建 WindowTravel 视图失败，请检查资源包是否已正确加载");
        }
    }
